...
//            }
    ...
    public void PrintValores(ArrayList<Piece> valores){
        ArrayList<Integer> valoresfinal = new ArrayList<Integer>();
            for (int k = 0; k < 16; k++){
                valoresfinal.add(valores.get(k).getValor());
            }
        System.out.println("Lista de numeros ordenados = " + valoresfinal);
    }
}
